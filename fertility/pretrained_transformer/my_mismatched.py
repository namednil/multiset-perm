...
@TokenEmbedder.register("pretrained_transformer_mismatched_rho")
class PretrainedTransformerMismatchedEmbedderRho(TokenEmbedder):
    """
    ...
    def __init__(
        ...
        self._matched_embedder = PretrainedTransformerEmbedderWithRho(
            model_name,
            rho=rho,
            train_rho=train_rho,
            freeze_embeddings=freeze_embeddings,
            not_adding_positional=not_adding_positional,
